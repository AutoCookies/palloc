...
EXTERN_C __declspec(selectany) const GUID ETW_PA_Provider = {0x138f4dbb, 0xee04, 0x4899, {0xaa, 0x0a, 0x57, 0x2a, 0xd4, 0x47, 0x57, 0x79}};

#ifndef ETW_PA_Provider_Traits
#define ETW_PA_Provider_Traits NULL
#endif // ETW_PA_Provider_Traits

//
// Event Descriptors
//
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR ETW_PA_ALLOC = {0x64, 0x1, 0x0, 0x4, 0x0, 0x0, 0x0};
#define ETW_PA_ALLOC_value 0x64
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR ETW_PA_FREE = {0x65, 0x1, 0x0, 0x4, 0x0, 0x0, 0x0};
#define ETW_PA_FREE_value 0x65
...
// Provider context
//
EXTERN_C __declspec(selectany) MCGEN_TRACE_CONTEXT ETW_PA_Provider_Context = {0, (ULONG_PTR)ETW_PA_Provider_Traits, 0, 0, 0, 0, 0, 0, 1, microsoft_windows_pallocEnableBits, microsoft_windows_pallocKeywords, microsoft_windows_pallocLevels};

//
// Provider REGHANDLE
//
#define microsoft_windows_pallocHandle (ETW_PA_Provider_Context.RegistrationHandle)
...
//
#define ETW_PA_Provider_EventWriteActivity 0
...
#define EventRegistermicrosoft_windows_palloc() McGenEventRegister(&ETW_PA_Provider, McGenControlCallbackV2, &ETW_PA_Provider_Context, &microsoft_windows_pallocHandle)
#endif
...
#define EventRegisterByGuidmicrosoft_windows_palloc(Guid) McGenEventRegister(&(Guid), McGenControlCallbackV2, &ETW_PA_Provider_Context, &microsoft_windows_pallocHandle)
#endif
...
#define EventRegistermicrosoft_windows_palloc_ForContext(pContext)             _mcgen_PASTE2(_mcgen_RegisterForContext_microsoft_windows_palloc_, MCGEN_EVENTREGISTER)(&ETW_PA_Provider, pContext)
    ...
    _Out_ McGenContext_microsoft_windows_palloc* pContext)
{
    ...
    pContext->Context.Logger = (ULONG_PTR)ETW_PA_Provider_Traits;
...
//
// Enablement check macro for event "ETW_PA_ALLOC"
//
#define EventEnabledETW_PA_ALLOC() _mcgen_EVENT_BIT_SET(microsoft_windows_pallocEnableBits, 0)
#define EventEnabledETW_PA_ALLOC_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_microsoft_windows_palloc(pContext)->EnableBits, 0)

//
// Event write macros for event "ETW_PA_ALLOC"
//
#define EventWriteETW_PA_ALLOC(Address, Size) \
        MCGEN_EVENT_ENABLED(ETW_PA_ALLOC) \
        ? _mcgen_TEMPLATE_FOR_ETW_PA_ALLOC(&ETW_PA_Provider_Context, &ETW_PA_ALLOC, Address, Size) : 0
#define EventWriteETW_PA_ALLOC_AssumeEnabled(Address, Size) \
        _mcgen_TEMPLATE_FOR_ETW_PA_ALLOC(&ETW_PA_Provider_Context, &ETW_PA_ALLOC, Address, Size)
#define EventWriteETW_PA_ALLOC_ForContext(pContext, Address, Size) \
        MCGEN_EVENT_ENABLED_FORCONTEXT(pContext, ETW_PA_ALLOC) \
        ? _mcgen_TEMPLATE_FOR_ETW_PA_ALLOC(&(pContext)->Context, &ETW_PA_ALLOC, Address, Size) : 0
#define EventWriteETW_PA_ALLOC_ForContextAssumeEnabled(pContext, Address, Size) \
        _mcgen_TEMPLATE_FOR_ETW_PA_ALLOC(&_mcgen_CheckContextType_microsoft_windows_palloc(pContext)->Context, &ETW_PA_ALLOC, Address, Size)

// This macro is for use by MC-generated code and should not be used directly.
#define _mcgen_TEMPLATE_FOR_ETW_PA_ALLOC _mcgen_PASTE2(McTemplateU0xx_, MCGEN_EVENTWRITETRANSFER)

//
// Enablement check macro for event "ETW_PA_FREE"
//
#define EventEnabledETW_PA_FREE() _mcgen_EVENT_BIT_SET(microsoft_windows_pallocEnableBits, 0)
#define EventEnabledETW_PA_FREE_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_microsoft_windows_palloc(pContext)->EnableBits, 0)

//
// Event write macros for event "ETW_PA_FREE"
//
#define EventWriteETW_PA_FREE(Address, Size) \
        MCGEN_EVENT_ENABLED(ETW_PA_FREE) \
        ? _mcgen_TEMPLATE_FOR_ETW_PA_FREE(&ETW_PA_Provider_Context, &ETW_PA_FREE, Address, Size) : 0
#define EventWriteETW_PA_FREE_AssumeEnabled(Address, Size) \
        _mcgen_TEMPLATE_FOR_ETW_PA_FREE(&ETW_PA_Provider_Context, &ETW_PA_FREE, Address, Size)
#define EventWriteETW_PA_FREE_ForContext(pContext, Address, Size) \
        MCGEN_EVENT_ENABLED_FORCONTEXT(pContext, ETW_PA_FREE) \
        ? _mcgen_TEMPLATE_FOR_ETW_PA_FREE(&(pContext)->Context, &ETW_PA_FREE, Address, Size) : 0
#define EventWriteETW_PA_FREE_ForContextAssumeEnabled(pContext, Address, Size) \
        _mcgen_TEMPLATE_FOR_ETW_PA_FREE(&_mcgen_CheckContextType_microsoft_windows_palloc(pContext)->Context, &ETW_PA_FREE, Address, Size)

// This macro is for use by MC-generated code and should not be used directly.
#define _mcgen_TEMPLATE_FOR_ETW_PA_FREE _mcgen_PASTE2(McTemplateU0xx_, MCGEN_EVENTWRITETRANSFER)
