# Working throughput plot
set terminal pngcairo size 1400,800 enhanced font 'Arial,10'
set output '../plots/throughput_comparison.png'

set title "Allocator Throughput Comparison (Vector Batch Churn)" font 'Arial,14' offset 0,-1
set xlabel "Benchmark (batch_size-vector_dim)" font 'Arial,10'
